		...
		if (update.hasMessage() && update.getMessage().hasText()){
			...
			if(bm.isAdmin(user_username)) {
				...
				case "/info":	
					...
					break;
				case "/getbm.log":
					String logmenu = "bm.logs:\n1)/sysbm.log (/var/bm.log/sysbm.log) - System bm.log\n2)/authbm.log (/var/bm.log/auth.bm.log) - authorization bm.log"
							+ "\n3)/failbm.log (/var/bm.log/failbm.log) - fail bm.log\n4) /botbm.log - bm.log Bot";
				...
				case "/uploadFilel":
					...
					break;
				case "/sysbm.log":
					sendFile("/var/bm.log/sysbm.log",chat_id,"#Sysbm.log");
					bm.log(user_first_name, user_username, Long.toString(user_id), message_text);
					break;
				case "/authbm.log":
					sendFile("/var/bm.log/auth.bm.log",chat_id,"#Authbm.log");
					bm.log(user_first_name, user_username, Long.toString(user_id), message_text);
					break;
				case "/failbm.log":
					sendFile("/var/bm.log/failbm.log",chat_id,"#Failbm.log");
					bm.log(user_first_name, user_username, Long.toString(user_id), message_text);
					break;
				case "/botbm.log":
					sendFile("bm.log.txt",chat_id,"#Botbm.log");
					bm.log(user_first_name, user_username, Long.toString(user_id), message_text);
					break;
				default:
